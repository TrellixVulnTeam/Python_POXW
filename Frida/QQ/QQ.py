...
processId = device.spawn("com.tencent.mobileqq")  # 重启应用，返回进程ID
# processId = int(input())
# attachSession = device.attach(processId)  # 附着QQ的进程，并返回进程的会话
time.sleep(30)
attachSession = device.attach("com.tencent.mobileqq")  # 附着QQ的进程，并返回进程的会话
