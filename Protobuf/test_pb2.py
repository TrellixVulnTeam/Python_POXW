...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\ntest.proto\x12\x04test\"\xd3\x01\n\x06Person\x12\x0c\n\x04name\x18\x01 \x02(\t\x12\n\n\x02id\x18\x02 \x02(\x05\x12\r\n\x05\x65mail\x18\x03 \x01(\t\x12(\n\x06phones\x18\x04 \x03(\x0b\x32\x18.test.Person.PhoneNumber\x1aI\n\x0bPhoneNumber\x12\x0e\n\x06number\x18\x01 \x02(\t\x12*\n\x04type\x18\x02 \x01(\x0e\x32\x16.test.Person.PhoneType:\x04HOME\"+\n\tPhoneType\x12\n\n\x06MOBILE\x10\x00\x12\x08\n\x04HOME\x10\x01\x12\x08\n\x04WORK\x10\x02\"+\n\x0b\x41\x64\x64ressBook\x12\x1c\n\x06people\x18\x01 \x03(\x0b\x32\x0c.test.Person')
)
...
_ADDRESSBOOK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='people', full_name='test.AddressBook.people', index=0,
