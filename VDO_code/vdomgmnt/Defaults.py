...
class Defaults(object):
  ...
  bioThreadsMax = 100
  bioThreadsMin = 1
  blockMapCacheSize = SizeString("512M")
  blockMapCacheSizeMaxPlusOne = SizeString("16T")
  blockMapCacheSizeMin = SizeString("512M")
  ...
  deduplication = Constants.disabled
  cpuThreads = 16
  cpuThreadsMax = 100
  cpuThreadsMin = 1
  emulate512 = Constants.enabled
  hashZoneThreads = 2
